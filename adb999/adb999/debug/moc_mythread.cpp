...
QT_MOC_LITERAL(1, 9, 16), // "Start_Screenshot"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6) // "Player"

    },
    "MyThread\0Start_Screenshot\0\0Player"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->Player((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::Start_Screenshot)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyThread::Start_Screenshot()
{
